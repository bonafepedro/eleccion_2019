...
def get_data():
    ...
    for i in iter_1:
        try: 
            response = requests.get(f'https://www.justiciacordoba.gob.ar/Estatico/JEL/Escrutinios/ReportesEleccion20190512/Resultados/E20190512_C{i[0]}%20%20%20%20_{i[1]}_0.htm',
                                        cookies=cookies,
                                        headers=headers,)
